...
const Quotations = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    showEventDateInPdf: false // checkbox to show/hide event date in PDF
  });
  ...
  const rejectedValue = quotations
            ...
            <div className="quotations__form-section">
              ...
              <div className="quotations__summary">
                ...
                <div className="quotations__form-group quotations__terms-section" style={{ marginTop: '1.5rem' }}>
                  <label style={{ fontSize: '16px', fontWeight: '600', marginBottom: '0.75rem', display: 'block' }}>
                    Terms & Conditions
                  </label>
