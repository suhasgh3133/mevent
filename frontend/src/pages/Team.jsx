...
import { FaUsers, FaTrash, FaEdit, FaMoneyBillAlt, FaReceipt } from 'react-icons/fa';
import './Team.scss';
          ...
          return filtered.map((member) => (
            <div key={member._id} className="team-card" onClick={() => openPaymentsForMember(member)}>
              ...
              <div className="team-card__actions">
                <button className="btn-primary btn-edit" onClick={(e) => { e.stopPropagation(); openEdit(member); }} title="Edit"><FaEdit /></button>
                <button
                ...
                <button className="btn-primary btn-delete" onClick={(e) => { e.stopPropagation(); deleteMember(member._id); }} title="Delete"><FaTrash /></button>
              </div>
            </div>
          ));
        })()}
